...
def get_upload_profile_image_path(instance, file):
    ...
    """
    return f"profile_images/user_{instance.id}/{file}"


def get_upload_album_cover_path(instance, file):
    """
    Returns file path to albums cover.
    Format: media/album_covers/user_id/photo.jpg
    """
    return f"album_covers/user_{instance.id}/{file}"
...
def get_upload_playlist_cover_path(instance, file):
    ...
    """
    return f"playlist_covers/user_{instance.id}/{file}"
...
def get_upload_audio_path(instance, file):
    ...
    """
    return f"audios/user_{instance.id}/{file}"
