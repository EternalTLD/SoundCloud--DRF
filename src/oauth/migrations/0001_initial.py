    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=src.base.services.get_upload_profile_image_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg']), src.base.services.validate_image_size])),
            ],
        ),
        migrations.CreateModel(
            name='SocialLink',
